...
oltp_conn_string = "postgresql://oltpAdmin:1234@localhost:5432/tstOltp"

#warehouse_conn_string = "postgresql://ftde01:ftde01-digitalskola@34.143.167.7:5432/ftde01_dwh"
warehouse_conn_string = "postgresql://dwhAdmin:1234@localhost:5432/tstDwh"
...
ddl_marts = {
    ...
    "insert_dm_sales_detail": """
        ...
        INSERT INTO dm_sales_detail_kel1 (order_item_id, order_id, product_id, product_category_name,
                                     order_item_quantity, product_discount)
